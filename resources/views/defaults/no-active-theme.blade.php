...
<html>
    ...
    <body class="bg-gray-200 font-sans">
        <div class="container mx-auto mt-40 text-center">
            ...
            <p class="text-lg text-blue-950 my-10">Could not load the active theme.<br><br>
                Check there is one defined in your settings area and check Aldrumo has an active database connection.</p>
